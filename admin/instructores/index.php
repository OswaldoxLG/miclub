...
<div class="container">
    <div class="row">
        <aside class="col-md-3 col-lg-2 bg-dark text-light p-3 aside-admininstruct">
            <div class="img_cat">
            <img src="<?php echo BASE_URL; ?>recursos/img/logo.png" alt="Mi Club Logo" class="img-fluid mb-3">
            <img src="<?php echo BASE_URL; ?>recursos/img/letras.png" alt="nombre del proyecto" class="img-fluid mb-3">
            </div>
